...
import { User, Mail, Phone, MapPin, Wrench, Save } from "lucide-react";
...
export default function FreelancerSettingsPage() {
  ...
  const fields = [
    ...
    { label: "Skills (comma separated)", value: skills, onChange: setSkills, icon: <Wrench className="w-5 h-5" />, disabled: false },
  ];
